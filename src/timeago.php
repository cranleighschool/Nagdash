...
{if ($timepointer == '') {
    ...
    $Clean = abs($Raw);
    $calcNum = [['s', 60], ['m', 60 * 60], ['h', 60 * 60 * 60], ['d', 60 * 60 * 60 * 24], ['mo', 60 * 60 * 60 * 24 * 30]];    // # Used for calculating
    $calc = ['s' => [1, 'second'], 'm' => [60, 'minute'], 'h' => [60 * 60, 'hour'], 'd' => [60 * 60 * 24, 'day'], 'mo' => [60 * 60 * 24 * 30, 'month']];    // # Used for units and determining actual differences per unit (there probably is a more efficient way to do this)
